...
class Stepper:
    ...
    def __step(self, dir):
        ...
        with self.lock:
            ...
            self.shifter_outputs.value &= bit
            self.shifter_outputs.value |= Stepper.seq[self.step_state] << self.shifter_bit_start
            self.s.shiftByte(self.shifter_outputs.value)
